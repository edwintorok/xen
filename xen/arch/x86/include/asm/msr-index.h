...
#define MSR_AMD64_MPERF_RO		0xc00000e7
#define MSR_AMD64_APERF_RO		0xc00000e8
#define MSR_AMD64_IR_PERF_COUNT		0xc00000e9
...
#define IBSFETCHCTL_IBSRANDEN		(_AC(1, ULL) << 57)
#define IBSFETCHCTL_MASK                (((_AC(1, ULL) << 56) - 1) | IBSFETCHCTL_IBSRANDEN)
#define IBSFETCHCTL_IBSPHYADDRVALID	(_AC(1, ULL) << 52)
#define MSR_AMD64_IBSFETCHLINAD		0xc0011031
#define MSR_AMD64_IBSFETCHPHYSAD	0xc0011032

#define MSR_AMD64_IBSOPCTL		0xc0011033
#define IBSOPTCTL_MASK			(~((_AC(1, ULL) << 16) | (_AC(0x1f, ULL) << 27) | (_AC(0x1f, ULL) << 59)))

#define MSR_AMD64_IBSOPRIP		0xc0011034
#define MSR_AMD64_IBSOPDATA		0xc0011035
#define MSR_AMD64_IBSOPDATA2		0xc0011036
#define MSR_AMD64_IBSOPDATA3		0xc0011037
#define IBSOPDATA3_IBSDCPHYADVAL        (_AC(1, ULL) << 18)
