...
#define FEATURESET_6c    14 /* 0x00000006.ecx      */
...
||||||| parent of 91ff478715 (x86/vpmu: expose writable APERF/MPERF MSR when vpmu is enabled)
=======
    fs[FEATURESET_6c] = p->basic._06c;
>>>>>>> 91ff478715 (x86/vpmu: expose writable APERF/MPERF MSR when vpmu is enabled)
}
